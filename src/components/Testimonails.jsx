...
const Testimonials = () => {
  ...
  return(
    ...
    className="container mx-auto py-10 lg:px-32 w-full overflow-hidden" id="Testimonials">
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>gfsdhfgtgbgvghdrfglkfj itgeorhtjjn </p>
      ...
      { testimonialsData.map((testimonial,index)=>(
        ...
        <div key={index} className="max-w-[240px] border shadow-lg rounded px-8 py-12 text-center">
